  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested menu" do
        ...
        Menu.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => menu.id, :menu => {'these' => 'params'}
      end

      it "assigns the requested menu as @menu" do
        menu = Menu.create! valid_attributes
        put :update, :id => menu.id, :menu => valid_attributes
        assigns(:menu).should eq(menu)
      end
